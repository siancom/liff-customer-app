...
const MOCK_COURSES = [
  { "เบอร์โทร": "0647268543", "เลขที่ใบคอส": "IrisCourse1333", "วันที่ซื้อ": "6/3/2569", "ครั้งที่เหลือดิบ": "3", "ครั้งที่ใช้": "0", "สถานะ": "ยังคงเหลือ", "สาขาที่ซื้อ": "เฉวง", "ชื่อคอส": "3.3หน้าใสครบเชต", "ผู้ซื้อคอส": "สุดารัตน์ สัจจพรหม", "ราคา": "999", "จำนวนครั้งที่ได้": "3", "ยอดชำระแล้วทั้งหมด": "999", "ยอดค้างชำระ": "0", "ประเภทการชำระ": "จ่ายเต็ม", "คิวอาร์โค้ด": "https://barcode.tec-it.com/barcode.ashx?data=IrisCourse1333" },
...
const MOCK_CUSTOMERS = [
  { "ชื่อ": "สุดารัตน์ สัจจพรหม", "ชื่อเล่น": "Faiฝ้าย", "เบอร์โทร": "0647268543", "สถานะสมาชิก": "ยังไม่สะสมยอด", "ปัญหาผิวหน้า": "ปกติ , สิว", "ยอดสะสม": "0", "หมายเลขใบสะสม": "Irismember1465" },
